                ...
                <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:flex lg:items-center lg:px-0 lg:text-left">
                  <div className="lg:py-24">
                    ...
                    <p className="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">
                      Automate every patient encounter and workflow, from front desk to back office.
                    </p>
                      ...
                      >
                        <div className="sm:flex">
                          ...
                          <div className="mt-3 sm:mt-0 sm:ml-3">
                            <button
                              type="submit"
                              className="block w-full rounded-md bg-gradient-to-r from-red-600 to-orange-600 py-3 px-4 font-medium text-white shadow hover:from-teal-600 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-gray-900"
                            >
                              Start free trial
                            </button>
                          </div>
