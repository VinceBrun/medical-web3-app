                  ...
                  <blockquote>
                    <div>
                      ...
                      <p className="mt-6 text-2xl font-medium text-white">
                        I have used studied and used the medial-dapp platform. And as a blockchain expert, I can boldly say that having medical records owned by the patient simply solves a llot of issues. 
                      </p>
                    </div>
                    <footer className="mt-6">
                      <p className="text-base font-medium text-white">Francis Ekpen</p>
                      <p className="text-base font-medium text-cyan-100">Co-Founder at Curiosityxploring</p>
                    </footer>
                  </blockquote>
                </div>
              </div>
          ...
          <div className="relative bg-gray-50 py-16 sm:py-24 lg:py-32">
            <div className="relative">
              <div className="mx-auto max-w-md px-6 text-center sm:max-w-3xl lg:max-w-7xl lg:px-8">
                ...
                <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Helpful Resources/M</p>
                <p className="mx-auto mt-5 max-w-prose text-xl text-gray-500">
